...
INSERT INTO "new_Job" ("applyLink", "city", "country", "createdAt", "description", "employerId", "expiresAt", "id", "status", "title") SELECT "applyLink", "city", "country", "createdAt", "description", "employerId", "expiresAt", "id", "status", "title" FROM "Job";
DROP TABLE "Job";
